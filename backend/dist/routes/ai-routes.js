 ...
 */
router.post('/extract-domains', ai_controller_js_1.extractDomains);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.post('/extract-domains-from-file', ai_controller_js_1.extractDomainsFromFileController);
/**
 * @swagger
 * /api/ai/suggest-rule:
 *   post:
 ...
 *         description: Internal Server Error.
 */
router.post('/suggest-rule', ai_controller_js_1.suggestAutomationRule);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.post('/suggest-commands', ai_controller_js_1.suggestCommandsForAlert);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.post('/diagnose-network', ai_controller_js_1.diagnoseNetwork);
/**
 * @swagger
 ...
 *         description: Internal Server Error.
 */
router.post('/suggest-script', ai_controller_js_1.suggestScript);
router.post('/suggest-script', ai_controller_js_1.suggestScript);
/**
 * @swagger
 * /api/ai/analyze-cidr:
 ...
 *         description: Internal Server Error.
 */
const ai_controller_js_2 = require("../controllers/ai-controller.js");
router.post('/analyze-cidr', ai_controller_js_2.analyzeCidrController);
/**
 * @swagger
 * /api/ai/chat:
 *   post:
 ...
 */
router.post('/chat', chat_controller_js_1.chat);
