...
const password_recovery_controller_js_1 = require("../controllers/password-recovery-controller.js");
 ...
 */
router.post('/send-code', password_recovery_controller_js_1.sendRecoveryCode);
/**
 * @swagger
 ...
 */
router.post('/verify-code', password_recovery_controller_js_1.verifyRecoveryCode);
/**
 * @swagger
 ...
 */
router.post('/reset-password', password_recovery_controller_js_1.resetPassword);
