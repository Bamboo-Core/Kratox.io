...
exports.formatAsHosts = formatAsHosts;
exports.formatAsUnbound = formatAsUnbound;
exports.formatAsBind = formatAsBind;
exports.formatAsJson = formatAsJson;
exports.formatAsCsv = formatAsCsv;
exports.formatBlocklist = formatBlocklist;
exports.getAvailableFormats = getAvailableFormats;
/**
 * Format domains as /etc/hosts file
 * Each line: 0.0.0.0 domain.com
 */
function formatAsHosts(domains, tenantName) {
 ...
 */
function formatAsUnbound(domains, tenantName) {
 ...
 */
function formatAsBind(domains, tenantName) {
 ...
 */
function formatAsJson(domains, tenantName) {
    const data = {
        tenant: tenantName,
 ...
 */
function formatAsCsv(domains, tenantName) {
 ...
 */
function formatBlocklist(format, domains, tenantName) {
    switch (format) {
        case 'hosts':
