...
exports.checkLoginAllowed = checkLoginAllowed;
 ...
 */
function getAttemptData(store, key) {
    const now = Date.now();
 ...
 */
function calculateLockoutDuration(consecutiveFailures) {
 ...
 */
function detectSuspiciousActivity(email, ip, userAgent) {
    const reasons = [];
