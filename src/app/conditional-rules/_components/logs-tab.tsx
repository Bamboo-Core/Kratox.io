  ...
  if (isLoading) {
    return (
      <div className="text-center">
        <Loader2 className="h-6 w-6 animate-spin" /> Carregando logs...
      </div>
    );
  }
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="sm:max-w-2xl">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Dados brutos do evento que disparou a regra e os detalhes da ação
                            executada.
                          </DialogDescription>
                        </DialogHeader>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto p-1">
                          <div>
                            <h4 className="font-semibold mb-2 flex items-center gap-2">
                              ...
                              Gatilho (Zabbix Event)
                            </h4>
                            <pre className="bg-muted text-xs p-2 rounded-md font-mono">
