...
async function fetchAlerts(): Promise<AlertType[]> {
  // For now, we are using mock data. This can be replaced with a real API call.
  // The API call would need to include the auth token.
  const mockAlerts: AlertType[] = [
      { id: "MOCK001", device: "Router-NYC-01-Mock", message: "High CPU utilization (95%)", severity: "Critical", time: "1 min ago", tenant: "Tenant A" },
      { id: "MOCK002", device: "Switch-LAX-05-Mock", message: "Interface down (Gig0/1)", severity: "Warning", time: "10 min ago", tenant: "Tenant B" },
  ];
