                ...
                <main className="flex-1 p-4 md:p-6 space-y-6 overflow-y-auto">
                    <Card className="shadow-lg">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Esta é a lista de todos os equipamentos (hosts) que seu usuário tem permissão para visualizar no Zabbix. Adicione as credenciais SSH para habilitar a execução de comandos.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="mb-4">
                                                        ...
                                                        {host.has_credentials ? (
                                                            <Tooltip>
                                                                <TooltipTrigger asChild>
                                                                     <Button variant="outline" size="sm" onClick={() => handleCredentialAction(host)}>
