...
import { useProfileMutation, profileFormSchema, type ProfileFormData } from '@/hooks/useProfileManagement';
            ...
            onSuccess: async (updatedUser) => {
                ...
                if (user?.email && values.password) {
                   await login(user.email, values.password);
                    ...
                    toast({ title: 'Aviso', description: 'Seu nome foi atualizado. As alterações serão totalmente refletidas no próximo login.' });
                }
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                     <Input id="picture" type="file" className="text-muted-foreground file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary/10 file:text-primary hover:file:bg-primary/20" disabled/>
                                </div>
                                <p className="text-xs text-muted-foreground">O upload de fotos será habilitado em breve.</p>
                            </div>
                        </div>
