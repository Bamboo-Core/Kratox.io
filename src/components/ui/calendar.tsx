    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 hover:bg-orange-500 hover:text-white"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-orange-500 hover:text-white focus:bg-orange-500 focus:text-white"
        ),
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-orange-100/50 aria-selected:text-muted-foreground",
