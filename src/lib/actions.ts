...
"use server";
import { suggestRulesFromDescription, type SuggestRulesFromDescriptionInput } from "@/ai/flows/suggest-rules-from-description";
import { z } from "zod";
...
export async function getAIRuleSuggestions(prevState: FormState, formData: FormData): Promise<FormState> {
  try {
