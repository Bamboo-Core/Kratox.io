...
export const handlers = [
  ...
  http.get('/api/dns/blocked-domains', (_req) => {
    return HttpResponse.json([
        { id: 'uuid-1', domain: "manual-block.com", blockedAt: new Date().toISOString(), source_list_id: null, source_list_name: null },
        { id: 'uuid-2', domain: "feed-block.com", blockedAt: new Date().toISOString(), source_list_id: 'uuid-list-1', source_list_name: "Phishing Feed" },
    ]);
  }),
];
