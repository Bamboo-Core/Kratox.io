                            ...
                            <TableRow key={alert.eventid} className="hover:bg-muted/50">
                                ...
                                <TableCell className="text-orange-500">
                                    {hostId ? (
                                        ...
                                        <span className="font-medium text-orange-500">{hostName}</span>
                                    )}
                                </TableCell>
                                ...
                                <TableCell className="text-center">
                                    {host && (
                                        <Button variant="ghost" size="icon" className='text-orange-500 hover:text-orange-600' onClick={() => onActionClick(alert, host)} title="Diagnosticar com IA">
